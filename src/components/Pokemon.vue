...
<script>
    ...
    export default {
        ...
        methods: {
            // request data
            getTeamsByPokemon(pokemon, page) {
                this.loading = true;
                this.$http.get('pokemon/' + pokemon, {
                    params: {
                        state: 1,
                        page: page
                    }
            ...
            handleCurrentChange(v) {
                this.getTeamsByPokemon(this.pokemon, v);
                this.curPage = v
            },
        ...
        created() {
            this.pokemon = this.$route.params.pokemon;
            this.getTeamsByPokemon(this.pokemon, 1);
